...
<%
	...
	String selectNum=request.getParameter("numPerpage");
%>    
        ...
        <div id="numPerpage-container">
        	...
        	<form id="numPerFrm" action="<%=request.getContextPath()%>/admin/memberList.do">
        		<select name="numPerpage" id="numPerpage">
        			<option value="10" <%=selectNum!=null&&selectNum.equals("10")?"selected":"" %>>10</option>
        			<option value="5" <%=selectNum!=null&&selectNum.equals("5")?"selected":"" %>>5</option>
        			<option value="3" <%=selectNum!=null&&selectNum.equals("3")?"selected":"" %>>3</option>
        		</select>
        	</form>
        </div>
        <table id="tbl-member">
